...
function sched(s) {
    if (s == "half") {
        ...
        if (s.startsWith("custom")) {
            ...
            gID("customizer").value = "period name | ending time [24hr]\n" + 
            ...
            find("hider").innerHTML = "[TOGGLE CUSTOM SCHEDULE EDITOR]";
        } else {
...
function fullScreen() {
    ...
    if(find("prt").classList.toggle("inv")) {
        ...
        var height = window.innerHeight.slice(0, -2) / 2;
