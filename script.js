    ...
    "corona": {
        "half": {
            "normal": {
                ...
                "PERIOD 1A":     time( 8, 49),
                "PASSING TO 1B": time( 9,  6),
                "PERIOD 1B":     time( 9, 16),
                "PASSING TO 2A": time( 9, 31),
                "PERIOD 2A":     time( 9, 41),
                "PASSING TO 2B": time( 9, 58),
                "PERIOD 2B":     time(10,  8),
                "PASSING TO 3A": time(10, 23),
                "PERIOD 3A":     time(10, 33),
                "PASSING TO 3B": time(10, 50),
                "PERIOD 3B":     time(11,  0),
                "PASSING TO 4A": time(11, 15),
                "PERIOD 4A":     time(11, 25),
                "PASSING TO 4B": time(11, 42),
                "PERIOD 4B":     time(11, 52),
                "PASSING TO 5A": time(12,  7),
                "PERIOD 5A":     time(12, 17),
                "PASSING TO 5B": time(12, 34),
                "PERIOD 5B":     time(12, 44),
                "PASSING TO 6A": time(12, 59),
                "PERIOD 6A":     time(13,  9),
                "PASSING TO 6B": time(13, 26),
                "PERIOD 6B":     time(13, 36),
                "PASSING TO 7A": time(13, 51),
                "PERIOD 7A":     time(14,  1),
                "PASSING TO 7B": time(14, 18),
                "PERIOD 7B":     time(14, 28),
                "PASSING TO 8A": time(14, 43),
                "PERIOD 8A":     time(14, 53),
                "PASSING TO 8B": time(15, 10),
                "PERIOD 8B":     time(15, 20),
                "SCHOOL IS TOMORROW": time(23, 59, 59),
            },
        },
        "normal": {
